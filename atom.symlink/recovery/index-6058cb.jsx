...
function renderLabel(primaryLabel, secondaryLabel) {
  return (
    <div className="feature-item__labels">
      {primaryLabel && <span class="feature-item__label feature-item__label--primary"></span>}
    </div>
  );
  ...
  return (
    <div className="gel-layout feature-item">
      <a href={href} className="feature-item__link" onClick={onClick}>
        ...
        <div className="feature-item__metadata mvt-feature-item__metadata gel-layout__item gel-1/2 gel-5/12@l gel-1/3@xl">
          {renderLabel(label)}
          {renderTitle(title)}
