...
describe('<FeatureItem />', () => {
  ...
  it.only('renders a primary label inside a container when passed in as a prop', () => {
    const { FeatureItem, mount } = getComponents(['FeatureItem']);
    ...
    assert(featureItem.querySelector('.feature-item__label'));
  });
