...
import procotolDetection from 'custom-protocol-detection'
...
export default class TvlModal extends Component {
  ...
  protocolClickHandler() {
    const uri = 'bbc-ipd:download/p06c494y/p06c4dzt/sd/standard/TG92ZSBhbmQgRHJ1Z3Mgb24gdGhlIFN0cmVldDogR2lybHMgU2xlZXBpbmcgUm91Z2ggLSBTZXJpZXMgMzogMi4gT3V0c2lkZSwgSW5zaWRl/p05l5jyk/TG92ZSBhbmQgRHJ1Z3Mgb24gdGhlIFN0cmVldDogR2lybHMgU2xlZXBpbmcgUm91Z2g=';
    procotolDetection(
      uri,
      function () { console.log('fail innit') },
      d,
      d
    );
  }
